...
<body>
    ...
    <div class="navegacion--none" id="nav">
        <nav class="navegacion">
            ...
            <a class="navegacion__enlace active" href="../../Administracion/Vista/index.php"><i class="fas fa-users"></i> Talento humano</a>
        ...
        <main class="contenedor">
            <div class="contenedor__bloque--conocenos">
                <div class="contenedor__texto--contactamos">
                    ...
                    <a href="Javascript:void()" onclick="abrirFlotante()"><i class="fa fa-plus iconoGris"></i></a>
                        ...
                        <table class="tabla">
                            ...
                            <tbody>
                                <tr class="fila">
                                    ...
                                    <td>Barros</td>
                                    <td>1001947988</td>
                                    <td>barrosjhon936@gmail.com</td>
                                    <td>Practicante Innovación</td>
                                    <td class="center">
                                        <a href="edit.php" class="link" title="Editar"><i class="fa fa-pencil color"></i></a>
                                        <a href="delete.php" class="link" title="Eliminar"><i class="fas fa-trash-alt color"></i></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>Gonzales</td>
                                    <td>1003457849</td>
                                    <td>alex18@gmail.com</td>
                                    <td>Jefe de Nómina</td>
                                    <td class="center">
                                        <a href="edit.php" class="link" title="Editar"><i class="fa fa-pencil color"></i></a>
                                        <a href="delete.php" class="link" title="Eliminar"><i class="fas fa-trash-alt color"></i></a>
                                    </td>
                ...
                <div id="flotante" class="contenedor__bloque--conocenos form--none" >
                    <div onclick="this.parentNode.style.display='none'" class="formulario"></div>

                    <div class="form">
                        <form action="" onclick="">
                            <div class="contenedor__form--talento">
                                <div class="cerrar">
                                    <p onclick="document.getElementById('flotante').style.display='none'" class="cerrar--talento"><i class="fa fa-close"></i></p>
                                </div>
                                ...
                                <div class="form--flex">
                                    ...
                                    <input class="form--input" type="email" id="email" placeholder="Correo electrónico de quién envía el FURD...">
                                </div>
                                
                                <div class="form--flex">
                                    <label class="form--label" for="nombre">Nombre del trabajador intervenido</label>
                                    <input class="form--input" type="text" id="nombre" placeholder="Nombre del trabajador...">
                                </div>

                                <div class="form--flex">
                                    <label class="form--label" for="fecha">Fecha de la intervención</label>
                                    <input class="form--input" type="date" id="fecha">
                                </div>

                                <div class="form--flex">
                                    <label class="form--label" for="archivo">Subir archivo</label>
                                    <input class="form--input archivo" type="file" required="" id="archivo">
                                </div>

                                <div class="form--flex">
                                    <label class="form--label" for="comentario">Comentarios generales: </label>
                                    <textarea id="comentario" class="form--input archivo" ></textarea>
                                </div>
