...
if ($_POST) {
    ...
    $modeloNomina->add($novedad_desde,$novedad_hasta,$cedula,$nombre,$salario,$fechaingreso,$centrodecosto,$cargo,$ordinario,$transporte,$horasrecargo,$domingocompensado,
