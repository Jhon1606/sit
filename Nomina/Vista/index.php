...
<head>
    ...
    <title>Nómina - SIT Contactamos</title>
...
<body>
        ...
        <div class="contenedor--header">
            <div class="flex--conocenos">
                ...
                <div class="contenedor--texto">
                    <h1 class="header--titulo-conocenos">Gestión de Nómina</h1>
                    <p class="header--texto--blanco">Es el proceso mediante el cual nuestros clientes 
                        reportan la información necesaria para el pago de salarios, comisiones o 
                        novedades de los empleados.</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="navegacion--none" id="nav">
        <nav class="navegacion" style="">
            ...
            <a class="navegacion__enlace active" href="../../Nomina/Vista/index.php"><i class="fas fa-hand-holding-usd"></i> Gestión de Nómina</a>
            ...
            <div class="contenedor__bloque--conocenos">
                <div class="contacto center">
                    ...
                    <div class="contacto--informacion">
                        <p class="contacto--texto"><i class='fas fa-user-alt'></i> <b>Johana Jaime</b></p>
                        <p class="contacto--texto"><i class='fas fa-user-tie'></i> <b>Jefe de Nómina </b> </p>
                        <p class="contacto--texto"><i class='fas fa-city'></i> Oficina Barranquilla</p>
                        <p class="contacto--texto"><i class='fa fa-mobile'></i> <b>Cel:</b> 3205423885</p>
                        <p class="contacto--texto"><i class='fas fa-phone-alt'></i> <b>Tel:</b> 3776363 <b>Ext.</b> 112</p>
                        <p class="contacto--texto"><i class='fa fa-envelope-open'></i> <b>E-mail:</b>jjaime@contactamos.com.co </p>
                    </div>
                </div>
    ...
    <section>
        <div class="titulo">
            <h1 class="titulo--conocenos">¿Qué hacer si desea reportar las novedades del personal?</h1>
        </div>
    ...
    <section>
        <div class="titulo">
            <h1 class="titulo--conocenos">Reportes de Nómina</h1>
        </div>
        ...
        <main class="contenedor">
            <div class="contenedor__bloque--conocenos">
                <div class="contenedor__texto--contactamos">
                    ...
                    <a href="Javascript:void()" onclick="abrirFlotante('Nomina')"><i class="fa fa-plus iconoGris"></i></a>
                    ...
                    <div class="crud">
                        <table class="tabla">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th class="anchop">Novedad desde</th>
                                    <th class="anchop">Hasta</th>
                                    <th class="anchop">Fecha de Registro</th>
                            ...
                            ?>
                                <tr class="fila">
                                    ...
                                    <td class="center"><?php echo formatDate($nomina['novedad_desde']); ?></td>
                                    <td class="center"><?php echo formatDate($nomina['novedad_hasta']); ?></td>
                                    <td class="center"><?php echo formatDate($nomina['fecharegistro']); ?></td>
                                    <td class="center">
                                        <a href="Javascript:void()" onclick="abrirFlotanteEditarNomina(<?php echo $nomina['id_nomina']; ?>)" class="link" title="Editar"><i class="fa fa-pencil color"></i></a>
                                        <a href="Javascript:void()" onclick="abrirFlotanteEliminar(<?php echo $nomina['id_nomina']; ?>)" class="link" title="Eliminar"><i class="fas fa-trash-alt color"></i></a>
                                    </td>
                                </tr>
                ...
                <div id="flotanteNomina" class="contenedor__bloque--conocenos form--none" >
                ...
                <div id="flotanteEditarNomina" class="contenedor__bloque--conocenos form--none" >
                    <div onclick="this.parentNode.style.display='none'" class="formulario"></div>
