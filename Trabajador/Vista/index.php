<?php
    ...
    $trabajadores = $modeloTrabajador->get();
?>
...
<head>
    ...
    <title>Trabajador - SIT Contactamos</title>
...
<body>
    <div class="navegacion--none" id="nav">
        <nav class="navegacion">
            ...
            <a class="navegacion__enlace active" href="../../Trabajador/Vista/index.php"><i class="fa fa-user"></i> Trabajadores</a>
    ...
    <section>
        <div class="titulo">
            <h1 class="titulo--conocenos">Trabajadores</h1>
        </div>
        ...
        <main class="contenedor">
            <div class="contenedor__bloque--conocenos">
                <div class="contenedor__texto--contactamos">
                    ...
                    <a href="Javascript:void()" onclick="abrirFlotante('Trabajador')"><i class="fa fa-plus iconoGris"></i></a>
                    <div class="crud">
                        <table class="tabla">
                            <thead>
                                <tr>
                                    ...
                                    <th class="anchoa2">Nombre</th>
                                    <th class="anchoa2">Centro de trabajo</th>
                            ...
                            ?>
                                <tr class="fila">
                                    <td><?php echo $trabajador['id_infseguridad']; ?></td>
                                    <td class="center"><?php echo $trabajador['identificaciont']; ?></td>
                                    <td class="center"><?php echo $trabajador['nombretrabajadort']; ?></td>
                                    <td class="center"><?php echo $trabajador['centrotrabajot']; ?></td>
                                    <td class="center">
                                        <a href="Javascript:void()" onclick="abrirFlotanteEditarTrabajador(<?php echo $trabajador['id_infseguridad']; ?>)" class="link" title="Editar"><i class="fa fa-pencil color"></i></a>
                                        <a href="Javascript:void()" onclick="abrirFlotanteEliminar(<?php echo $trabajador['id_infseguridad']; ?>)" class="link" title="Eliminar"><i class="fas fa-trash-alt color"></i></a>
                                    </td>
                                </tr>
                            <?php
                                }
                ...
                <div id="flotanteTrabajador" class="contenedor__bloque--conocenos form--none" >
                ...
                <div id="flotanteEditarTrabajador" class="contenedor__bloque--conocenos form--none" >
                    <div onclick="this.parentNode.style.display='none'" class="formulario"></div>
