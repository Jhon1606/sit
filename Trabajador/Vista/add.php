...
<form action="../Controlador/add.php" method="POST" >
    <div class="contenedor__form--seleccion auto">
        ...
        <div class="cerrar">
            <p onclick="document.getElementById('flotanteTrabajador').style.display='none'" 
        ...
        <div class="tituloSeleccion">
            <h2 class="tituloCrud"><i class="fas fa-user-shield"></i> Añadir trabajador</h2>
        </div>

        <div class="form--flex">
            <label class="form--label" for="nombretrabajadort">Nombre del trabajador</label>
            <input type="text" class="form--input" name="nombretrabajadort" placeholder="Nombre del trabajador..."
        ...
        <div class="form--flex">
            ...
            <select name="tipodocumentot" class="form--input">
        ...
        <div class="form--flex">
            ...
            <input type="number" class="form--input" name="identificaciont" placeholder="Número de identificación..." >
        </div>

        <div class="form--flex">
            <label class="form--label" for="nacimientot">Fecha de nacimiento</label>
            <input type="date" class="form--input" name="nacimientot">
        </div>

        <div class="form--flex">
            <label class="form--label" for="sexot">Sexo</label>
            <select name="sexot" class="form--input">
                <option value="">Seleccione una opción</option>
        ...
        <div class="form--flex">
            ...
            <input class="form--input" type="text" name="epst" placeholder="EPS...">
        </div>

        <div class="form--flex">
            <label class="form--label" for="afpt">AFP</label>
            <input class="form--input" type="text" name="afpt" placeholder="AFP...">
        </div>

        <div class="form--flex">
            <label class="form--label" for="cargot">Cargo</label>
            <input class="form--input" type="text" name="cargot" placeholder="Cargo...">
        </div>

        <div class="form--flex">
            <label class="form--label" for="fechaingresot">Fecha de ingreso</label>
            <input type="date" class="form--input" name="fechaingresot">
        </div>

        <div class="form--flex">
            <label class="form--label" for="ocupaciont">Ocupación habitual</label>
            <input type="text" class="form--input" name="ocupaciont">
        </div>

        <div class="form--flex">
            <label class="form--label" for="salariot">Salario</label>
            <input type="number" class="form--input" name="salariot">
        </div>

        <div class="form--flex">
            <label class="form--label" for="centrodecostot">Centro de costo</label>
            <input type="text" class="form--input" name="centrodecostot">
        </div>

        <div class="form--flex">
            <label class="form--label" for="zonat">Zona</label>
            <input type="text" class="form--input" name="zonat">
        </div>

        <div class="form--flex">
            <label class="form--label" for="tipovinculaciont">Tipo de vinculación</label>
            <select name="tipovinculaciont" class="form--input">
                <option value="">Seleccione una opción</option>
        ...
        <div class="form--flex">
            ...
            <select name="departamentot" required="" class="form--input" onchange="cargarMunicipiosCrear(this.value, '')">
                ...
                function cargarMunicipiosCrear(idDepartamento, idMunicipio)
                {
                    $.ajax({
                        ...
                        success: function(selectMunicipios){
                            ...
                            document.getElementById("divMunicipioCrear").innerHTML = selectMunicipios;
        ...
        <div class="form--flex">
            ...
            <input type="text" class="form--input" name="direcciont">
        </div>

        <div class="form--flex">
            <label class="form--label" for="centrotrabajot">Centro de trabajo</label>
            <input type="text" class="form--input" name="centrotrabajot"
            onChange="this.value=(this.value).toUpperCase()" style="text-transform:uppercase">
        </div>

        <div class="form--flex">
            <label class="form--label" for="jornadat">Jornada de trabajo habitual</label>
            <select name="jornadat" class="form--input">
