...
<head>
    ...
    <title>Retiro de personal - SIT Contactamos</title>
...
<body>
        ...
        <div class="contenedor--header">
            <div class="flex--conocenos">
                ...
                <div class="contenedor--texto">
                    <h1 class="header--titulo-conocenos">Retiro de Personal</h1>
                    <p class="header--texto--blanco center">Es el proceso mediante se solicita y realiza 
                        formalmente el retiro del personal, aplicando las validaciones y controles legales 
                        y definidos en el acuerdo de servicio.</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="navegacion--none" id="nav">
        <nav class="navegacion">
            ...
            <a class="navegacion__enlace active" href="../../Retiro/Vista/index.php"><i class="fas fa-user-minus"></i> Retiro de personal</a>
    ...
    <section>
        <div class="titulo">
            <h1 class="titulo--conocenos">¿Qué hacer si desea retirar personal?</h1>
        </div>
    ...
    <section>
        <div class="titulo">
            <h1 class="titulo--conocenos">Solicitud de Retiro</h1>
        </div>
        ...
        <main class="contenedor">
            <div class="contenedor__bloque--conocenos">
                <div class="contenedor__texto--contactamos">
                    ...
                    <a href="Javascript:void()" onclick="abrirFlotante('Retiro')"><i class="fa fa-plus iconoGris"></i></a>
                    ...
                    <div class="crud">
                        <table class="tabla">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th class="anchop">Fecha de retiro</th>
                                    <th class="anchop">Nombre</th>
                            ...
                            ?>
                                <tr class="fila">
                                    ...
                                    <td class="center"><?php echo formatDate($retiro['fecharetiro']); ?></td>
                                    <td class="center"><?php echo $retiro['nombre']; ?></td>
                                    <td class="center"><?php echo formatDate($retiro['fecharegistro']); ?></td>
                                    <td class="center">
                                        <a href="Javascript:void()" onclick="abrirFlotanteEditarRetiro(<?php echo $retiro['id_retiro']; ?>)" class="link" title="Editar"><i class="fa fa-pencil color"></i></a>
                                        <a href="Javascript:void()" onclick="abrirFlotanteEliminar(<?php echo $retiro['id_retiro']; ?>)" class="link" title="Eliminar"><i class="fas fa-trash-alt color"></i></a>
                                    </td>
                                </tr>
                ...
                <div id="flotanteRetiro" class="contenedor__bloque--conocenos form--none" >
                ...
                <div id="flotanteEditarRetiro" class="contenedor__bloque--conocenos form--none" >
                    <div onclick="this.parentNode.style.display='none'" class="formulario"></div>
